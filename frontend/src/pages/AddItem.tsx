...
export default function AddItem() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert('Failed to add item: Unable to connect to server');
    }
  };
  ...
  return (
    <AppLayout>
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          <h1 className="text-4xl font-bold text-foreground mb-2">Add New Item</h1>
          <p className="text-muted-foreground">Add a new item to your pantry inventory</p>
        </div>
